...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.dtmamhx.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
  try {
    ...
    const paymentCollection = client.db("topSpin").collection("payments");
